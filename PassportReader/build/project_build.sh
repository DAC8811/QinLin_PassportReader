...
#-DCMAKE_C_FLAGS=" -fPIC -fdata-sections -ffunction-sections -Wl,--gc-sections -fvisibility=hidden " \
#-DCMAKE_CXX_FLAGS="-std=gnu++11 -fexceptions -fPIC -fdata-sections -ffunction-sections -Wl,--gc-sections -fvisibility=hidden "
