...
#define RF_RECV_IDCARD_FINGER_LEN  0x400

#define RF_RECV_IDCARD_INFO_POS    0x0E
#define RF_RECV_IDCARD_PIC_POS     (RF_RECV_IDCARD_INFO_POS + RF_RECV_IDCARD_INFO_LEN)
#define RF_RECV_IDCARD_FINGER_POS  (RF_RECV_IDCARD_INFO_POS + RF_RECV_IDCARD_INFO_LEN + RF_RECV_IDCARD_PHOTO_LEN)

#define RF_RECV_IDCARD_INFO_POS1    0x10
#define RF_RECV_IDCARD_PIC_POS1     (RF_RECV_IDCARD_INFO_POS1 + RF_RECV_IDCARD_INFO_LEN)
#define RF_RECV_IDCARD_FINGER_POS1  (RF_RECV_IDCARD_INFO_POS1 + RF_RECV_IDCARD_INFO_LEN + RF_RECV_IDCARD_PHOTO_LEN)
...
class RFReader {
  ...
  ****************************************************************/
  ...
  //----------------------------------------------------------
  unsigned int RF_14443_Reset(unsigned char cPara, unsigned char *cpInfo, unsigned char *cpLen, RF_SPEED s);
